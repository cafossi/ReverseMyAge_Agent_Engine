        ...
        <div style={{ marginBottom: '60px', marginTop: '30px', position: 'relative' }}>
          ...
          {showReportingLines && (
            ...
            >
              ...
              {/* Leadership nodes */}
              <circle cx="36.5%" cy="320px" r="6" fill="#00d4ff" filter="url(#cyanGlow)" />
              <circle cx="50%" cy="360px" r="6" fill="#00d4ff" filter="url(#cyanGlow)" />
              <circle cx="64%" cy="320px" r="6" fill="#00d4ff" filter="url(#cyanGlow)" />

              {/* Vertical lines to core agents */}
              <rect x="36.5%" y="325px" width="1.5px" height="63px" fill="rgba(255,255,255,0.8)" filter="url(#cyanGlow)" />

              
              
              <rect x="50%" y="365px" width="1.5px" height="22px" fill="rgba(255,255,255,0.8)" filter="url(#cyanGlow)" />
             

              <rect x="64%" y="325px" width="1.5px" height="63px" fill="rgba(255,255,255,0.8)" filter="url(#cyanGlow)" />
              

              {/* Horizontal line across core agents */}
              {/*<rect x="13.5%" y="726px" width="73%" height="2px" fill="#00d4ff" rx="1" filter="url(#cyanGlow)" />*/}

              {/* Core agent end nodes */}
              
              <rect x="13.5%" y="385px" width="1.5px" height="25px" fill="rgba(255,255,255,0.8)" filter="url(#cyanGlow)" />
              <circle cx="86.5%" cy="410px" r="5" fill="#00d4ff" filter="url(#cyanGlow)" />

              <rect x="86.5%" y="385px" width="1.5px" height="25px" fill="rgba(255,255,255,0.8)" filter="url(#cyanGlow)" />
              <circle cx="13.5%" cy="410px" r="5" fill="#00d4ff" filter="url(#cyanGlow)" />
            </svg>
          )}
