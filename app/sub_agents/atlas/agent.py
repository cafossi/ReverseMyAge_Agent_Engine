...
"""Atlas Analytics Agent for the Nexus Command system.

Formerly the NBOT Analytics Agent, Atlas focuses on operational KPIs such as
NBOT hours, scheduling efficiency, and related performance metrics.
...
# Reports
# from .report_tool import build_nbot_report
...
# ============================================================
# 🤖 NBOT Agent Definition
# ------------------------------------------------------------
agent = Agent(
    model=os.getenv("ATLAS_AGENT_MODEL"),
    name="atlas_agent",
    instruction=return_instructions_root(),
    global_instruction=(
        f"""
        You are **Atlas**, the Analytics Agent in the Nexus Command system.
        Your scope is operational KPIs such as NBOT hours, scheduling efficiency,
        and related performance metrics that explain past performance.
