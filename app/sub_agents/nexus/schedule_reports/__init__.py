...
from .reports.site_health import generate_site_health
...
def generate_standard_report(
    ...
    Args:
        ...
        location_id: Location ID (required for site-specific reports)
    ...
    return f"Report '{report_id}' not implemented. Available: site_health, customer_overview, region_overview, optimization_card, pareto_optimization"
